...
*Variant of [sort](/src/flattened/Office.flattened.sol/library.Arrays.md#sort) that sorts an array of uint256 in increasing order.*
...
*Variant of [sort](/src/flattened/Office.flattened.sol/library.Arrays.md#sort) that sorts an array of address in increasing order.*
...
*Variant of [sort](/src/flattened/Office.flattened.sol/library.Arrays.md#sort) that sorts an array of bytes32 in increasing order.*
...
Invariant: `begin <= end`. This is the case when initially called by [sort](/src/flattened/Office.flattened.sol/library.Arrays.md#sort) and is preserved in subcalls.
...
IMPORTANT: Deprecated. This implementation behaves as [lowerBound](/src/flattened/Office.flattened.sol/library.Arrays.md#lowerbound) but lacks
...
*Same as [lowerBound](/src/flattened/Office.flattened.sol/library.Arrays.md#lowerbound), but with an array in memory.*
...
*Same as [upperBound](/src/flattened/Office.flattened.sol/library.Arrays.md#upperbound), but with an array in memory.*
