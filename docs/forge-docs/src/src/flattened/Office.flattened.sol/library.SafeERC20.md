...
*Variant of [safeTransfer](/src/flattened/Office.flattened.sol/library.SafeERC20.md#safetransfer) that returns a bool instead of reverting if the operation is not successful.*
...
*Variant of [safeTransferFrom](/src/flattened/Office.flattened.sol/library.SafeERC20.md#safetransferfrom) that returns a bool instead of reverting if the operation is not successful.*
...
this function. Performing a [safeIncreaseAllowance](/src/flattened/Office.flattened.sol/library.SafeERC20.md#safeincreaseallowance) or {safeDecreaseAllowance} operation on a token contract
...
|`data`|`bytes`|The call data (encoded using abi.encode or one of its variants). This is a variant of [_callOptionalReturnBool](/src/flattened/Office.flattened.sol/library.SafeERC20.md#_calloptionalreturnbool) that reverts if call fails to meet the requirements.|
...
|----|----|-----------|
|`token`|`IERC20`|The token targeted by the call.|
|`data`|`bytes`|The call data (encoded using abi.encode or one of its variants). This is a variant of [_callOptionalReturn](/src/flattened/Office.flattened.sol/library.SafeERC20.md#_calloptionalreturn) that silently catches all reverts and returns a bool instead.|
