...
**Inherits:**
[IOffice](/src/flattened/Office.flattened.sol/interface.IOffice.md), [OfficeStorage](/src/flattened/Office.flattened.sol/abstract.OfficeStorage.md), [Context](/src/flattened/Office.flattened.sol/abstract.Context.md), [Registry](/src/flattened/Office.flattened.sol/abstract.Registry.md), [TransientEnumerableHashTableStorage](/src/flattened/Office.flattened.sol/abstract.TransientEnumerableHashTableStorage.md)
...
*We don't check health of the account after this action given that the collateral
...
*Overriden to ensure that the `from` account is healthy after `tokenId` transfer.
